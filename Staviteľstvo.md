...
- Rozdelenie podľa tvaru
    - Základové pásy
        - Pod bežnými múrmi
        - Materiál odolný voči vlhkosti
        - Zhotovenie
            - Priamo do ryhy - betón
            - Do debnenia - oceľobetón
        - Rozmery závisia od
            - Zaťaženia na ne
            - Druhu základovej pôdy
        - Výška
            - Odvodzuje sa od previsnutej časti pásu tak, aby sa nezlomil
            - Uvažuje sa roznášací uhol $\alpha$, ktorý nesmie vyjsť bočnou stenou
        - Šírka
            - Stanovuje sa statickým výpočtom
            - Vzhľadom na uhol $\alpha$ môže byť jednostupňový alebo viacstupňový
    - Základové rošty
        - Sústava navzájom kolmých pásov
        - Používajú sa pri skeletových konštrukciách na nerovnomerné stlačiteľných zeminách
        - Tvar
            - Zvyčajne obdĺžnikový prierez
            - Môže byť obrátené **T**
    - Základové pätky
        - Na založenie skeletových konštrukcií (pod stĺpy)
        - Pôdorysný prierez
            - Štvorec
            - Kruh
            - Obdĺžnik
        - Tvar výšky
            ...
            - Viacstupňové
        - Roznášací uhol 60°
        - Montované pätky sú s kalichom na osadenie stĺpu
    - Základové dosky
        - Zaberajú celý pôdorysný rozmer stavby
        - Zo statického hľadiska je to obrátená stropná konštrukcia
        - Používa sa
            - Ak je základová škára trvale pod hladinou spodnej vody *(akoby spodok vane)?*
            - Výškové stavby z ekonomického hľadiska
        - Výška býva 600 až 1200 mm
        - Pri skeletových konštrukciách v miestach stĺpov býva zosilnená hríbovými hlavicami

### Hlbinné základy
- Používajú sa
    - Ak je únosná zemina vo väčšej hĺbke ako 2 m
    - Ak by bola realizácia plošných základov neekonomická a nemožná
- Podstata
    - Prenesenie zaťaženia stavby do únosnej zeminy
- Spôsoby prenosu
    - Opreté o únosnú zeminu
    - Plávajúce - trením o únosnú zeminu
- Spôsoby vyhotovenia
    - Vŕtaním
        - Zábrany proti zrúteniu
        - Oceľovou rúrou
        - Naliatím betonitu
        - Ak je oceľobetón - vloženie výstužného koša
        - Zaliatie betónom
        - Postupne vyťahované rúry
        - Po zatvrdnutí vyhotovené hlavice
    - Vháňaním
        - Zatĺkaním strojovým zariadením
        - Spôsoby
            - Baranením
            - Vytláčaním
            - Vibrovaním
...
- Podľa použitej
    - Malty
        ...
        - Cementová
        - Vápenno-cementová
    - Lepidla - podľa druhu murovacieho prvku
    - Materiálu
        - Kameň
        - Keramika
            - Tehly 
...
### Tehly
Použitie
- Nevykurované objekty (sklady, garáže)
- Stĺpy
- Komíny

Vlastnosti
- Dobré spojenie s maltou
- Dobré prisekávanie
- Dobrá nosnosť muriva
- Zlá tepelnoizolačnosť (hrúbka 900 mm)

### Väzba muriva
Zostavenie tehál tak, aby nad sebou neprebiehali stykové škáry  
Dôvod - vplyv na únosnosť muriva  

Zásady:
- Stykové škáry (zvislé) navzájom posunúť o $\frac{1}{2}$ alebo $\frac{1}{4}$ šírky tehly
- Ložné škáry vyhotoviť kolmo na tlak vodorovne
- Vhodné murovať z celých tehál  
- Tehly možno sekať na $\frac{1}{2}$, $\frac{1}{4}$, $\frac{3}{4}$ alebo pásiky
- Prisekané sa môžu použiť pri ukončení, pripojení, zalomení, zúžení alebo križovaní múrov
...
Výhody
- Veľká pevnosť
- Odolnosť voči vlhku a ohňu

Nevýhody
- Namáhavá práca
- Nutnosť mechanizácie pri opracovaní
...
- Z lomového kameňa
    ...
    - Veľmi staré stavby
- Kyklopské
    - Kameň v tvare 4- až 8-uholníka
    - Z jedného miesta vychádzajú 3 škáry
    - Nesmú byť priebežné zvislé ani ložné škáry
- Riadkové
    - Z opracovaného kameňa na hrubo alebo čisto
    - Strany sú približne vodorovné a kolmé
    - Čím presnejšie opracované, tým môžu byť škáry tenšie
    - Musí byť dodržaná väzba (zvislé škáry min. 100 mm)
- Haklíkové
    - Sú v ňom kamene, ktorých výška je cez 2 a viac vodorovných vrstiev

### Zmiešané murivo
Druhy 
    - Kameň a tehla
    - Kameň a betón
    - Tehla a betón - tehly ako debnenie

Použitie
- Podradné konštrukcie
- V minulosti
- Hradné múry v Bojniciach

<!-- 
### Monolitické konštrukcie
Vyhotovenie priamo na stavbe
1. Zhotovenie formy pre konštrukciu
    - Debnenie
    - Výkop v zemi
2. Vloženie výstuže (ak treba)
3. Naliatie betónu
4. Zatuhnutie betónu
